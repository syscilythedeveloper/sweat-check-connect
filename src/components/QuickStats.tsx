...
const QuickStats = ({ streak = 5, weeklyProgress = 3, weeklyGoal = 7 }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-[0_0_6px_1px_rgba(168,85,247,0.4)] p-3 flex flex-col gap-2 border border-gray-100 dark:border-transparent w-full max-w-xs">
